...
using Notepad_Light.NetSpeller.Affix;
using Notepad_Light.NetSpeller.Phonetic;
...
namespace Notepad_Light.NetSpeller
{
    public class WordDictionary
    {
        ...
        private string _dictionaryFolder = AppDomain.CurrentDomain.BaseDirectory + "\\Dictionaries\\";
