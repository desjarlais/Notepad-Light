...
namespace Notepad_Light.NetSpeller
{
    public class Spelling
    {
        ...
        private MatchCollection? _htmlTags = null;
        private MatchCollection? _words = null;
        #endregion
        ...
        public Spelling()
        {
            _htmlTags = _htmlRegex.Matches(string.Empty);
            _words = _wordEx.Matches(string.Empty);
            _dictionary = new WordDictionary();
            _suggestionForm = null;
            Initialize();
        }
